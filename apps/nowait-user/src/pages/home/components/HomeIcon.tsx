...
export function WaitingIcon({ waitingCount = 0 }: WaitingIconProps) {
  return (
    <div className="px-1.5 py-1.5 rounded-md bg-[#FFF0EB]">
...
export function WaitingCardIcon({ waitingCount = 0 }: WaitingIconProps) {
  return (
    <div className="px-1.5 py-1.5 w-13.5 h-5 rounded-md bg-[#FFFFFF]/30 flex items-center justify-center">
...
export function NotOpenIcon() {
  return (
    <div className="px-1.5 py-1.5 rounded-md bg-[#F7F7F7]">
